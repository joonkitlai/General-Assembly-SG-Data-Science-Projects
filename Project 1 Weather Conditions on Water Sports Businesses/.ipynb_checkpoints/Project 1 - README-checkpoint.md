...
Weather patterns can have a significant impact on businesses offering outdoor water activities. For example, if it is rainy or dark, too warm or cold, people may be less likely to participate in outdoor water activities. 

Happy Water House (HWH), an outdoor water sports centre located in East Coast Park recognises the need to adapt its business to the weather pattern in Singapore. In particular, HWH hopes to mitigate the risk of losing customers during severe weather (i.e. rainy, dark, too warm/cold) by introducing indoor activities (e.g. F&B, wave pool) to complement their outdoor water sports business.

This project aims to analyse the monthly weather patterns in Singapore to identify the windows of severe weather conditions (i.e. rainy, dark, too warm/cold) in a year. This would serve two purposes: 

(i) to justify the resources to be invested into developing new indoor activities business. For example, if the window of severe weather is relatively large, it may justify higher investment into the development. 

(ii) to better plan and allocate resources to outdoor water activities and upcoming indoor activities. For example, more manpower could be pre-allocated to the indoor activities segment to provide a good experience for their customers.
...
|rainy_days|integer|rainfall-monthly-number-of-rain-days|Total rainy days in a month| 
|sunshine_hrs|float|sunshine-duration-monthly-mean-daily-duration|Total sunshine hours in a month
|air_temp|float|surface-air-temperature-monthly-mean-daily-minimum|Minimum mean surface air temperature in a month| 
